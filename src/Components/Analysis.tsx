            ...
            <Container>
                ...
                <Row>
                    ...
                    <Col lg={6} md={12} sm={12}>
                        <p className="text-justify details">When crafting web applications, I typically rely on Next.js as my go-to framework, appreciated for its versatility and efficiency. Its seamless integration of React and Node.js ensures smooth development and excellent performance. However, every client comes with unique demands and preferences, and I am always ready to adapt to their specific needs.</p>
